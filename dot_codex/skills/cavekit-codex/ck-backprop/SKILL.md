...
Canonical upstream source: `skills/backprop/SKILL.md` @ `028643f913996cfe1c59f261627d167d4ab5477f`.

Invocation translation:
- upstream `/ck:backprop` -> Codex `$ck-backprop`
...
- Test failed at `$ck-build` verification.
- User reports bug.
- Post-mortem after production incident.
- `$ck-check` flags VIOLATE with root cause found.
